...
public class Percolation {
    ...
    public Percolation(int n) {
        ...
        if (isValidGSize) {
            ...
            // Open top and bottom roots (fixed nodes for efficiency)
    ...
    public boolean isFull(int row, int col) {
        ...
        if (isInpValid) {
            ...
            ret = uf.connected(siteIdx, topRoot);
        }
        return ret;
    }
    ...
    public boolean percolates() {
        ...
        ret = uf.connected(topRoot, botRoot);
        return ret;
    }
    ...
    private void connect2Neighbours(int row, int col) {
        ...
        if (row != gridWidth) {
            ...
            // special cases for efficiency
            // If top row, connect to the bottom root
