...
public class PercolationStats {
    ...
    private int perfPercolation() {
        ...
        Percolation pl = new Percolation(gWidth);
    ...
    private void runTrails(int nOfTrials) {
        ...
        for (int i = 0; i < nOfTrials; i++) {
            ...
            fOfOsPerTrial[i] = (double) ((nOfOpenSites * 1.0) / (gWidth * gHeight));
        }
        ...
        lowConf = mn - ((1.96 * stdDev) / Math.sqrt(nOfTrials));
        highConf = mn + ((1.96 * stdDev) / Math.sqrt(nOfTrials));
    }
}
